...
class Note extends DataClass implements Insertable<Note> {
  ...
  @override
  int get hashCode => Object.hash(id, patientId, content, author, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Note &&
...
class SyncConflict extends DataClass implements Insertable<SyncConflict> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || clientPayload != null) {
  ...
  SyncConflictsCompanion toCompanion(bool nullToAbsent) {
    return SyncConflictsCompanion(
      ...
      clientPayload: clientPayload == null && nullToAbsent
          ? const Value.absent()
          : Value(clientPayload),
  ...
  SyncConflict copyWith({
    ...
    clientPayload: clientPayload.present
        ? clientPayload.value
        : this.clientPayload,
...
class $EntityVersionsTable extends EntityVersions
    with TableInfo<$EntityVersionsTable, EntityVersion> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<EntityVersion> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  EntityVersion map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
...
class EntityVersion extends DataClass implements Insertable<EntityVersion> {
  final String entityType;
  final String entityId;
  final int version;
  final DateTime updatedAt;
  ...
  factory EntityVersion.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  EntityVersion copyWithCompanion(EntityVersionsCompanion data) {
    return EntityVersion(
      entityType: data.entityType.present
          ? data.entityType.value
          : this.entityType,
  ...
  @override
  String toString() {
    return (StringBuffer('EntityVersion(')
          ..write('entityType: $entityType, ')
          ..write('entityId: $entityId, ')
  ...
  @override
  int get hashCode => Object.hash(entityType, entityId, version, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class EntityVersionsCompanion extends UpdateCompanion<EntityVersion> {
  final Value<String> entityType;
  final Value<String> entityId;
  ...
  EntityVersionsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       entityId = Value(entityId),
       updatedAt = Value(updatedAt);
  static Insertable<EntityVersion> custom({
    Expression<String>? entityType,
    Expression<String>? entityId,
...
class Vital extends DataClass implements Insertable<Vital> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, patientId, type, value, unit, recordedAt, recordedBy);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Vital &&
...
class $WoundPhotosTable extends WoundPhotos
    with TableInfo<$WoundPhotosTable, WoundPhoto> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $WoundPhotosTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  static const VerificationMeta _serverFilePathMeta = const VerificationMeta(
    'serverFilePath',
  );
  @override
  late final GeneratedColumn<String> serverFilePath = GeneratedColumn<String>(
    'server_file_path',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'wound_photos';
  @override
  VerificationContext validateIntegrity(
    Insertable<WoundPhoto> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('server_file_path')) {
      context.handle(
        _serverFilePathMeta,
        serverFilePath.isAcceptableOrUnknown(
          data['server_file_path']!,
          _serverFilePathMeta,
        ),
      );
    }
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  WoundPhoto map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return WoundPhoto(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
      ...
      serverFilePath: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}server_file_path'],
      )!,
  ...
  @override
  $WoundPhotosTable createAlias(String alias) {
    return $WoundPhotosTable(attachedDatabase, alias);
  }
}

class WoundPhoto extends DataClass implements Insertable<WoundPhoto> {
  final String id;
  final String patientId;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['server_file_path'] = Variable<String>(serverFilePath);
  ...
  WoundPhotosCompanion toCompanion(bool nullToAbsent) {
    return WoundPhotosCompanion(
      id: Value(id),
      patientId: Value(patientId),
      filePath: Value(filePath),
      serverFilePath: Value(serverFilePath),
      note: Value(note),
  ...
  factory WoundPhoto.fromJson(
    ...
    return WoundPhoto(
      ...
      serverFilePath: serializer.fromJson<String>(json['serverFilePath']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'serverFilePath': serializer.toJson<String>(serverFilePath),
  ...
  WoundPhoto copyWithCompanion(WoundPhotosCompanion data) {
    return WoundPhoto(
      id: data.id.present ? data.id.value : this.id,
      patientId: data.patientId.present ? data.patientId.value : this.patientId,
      filePath: data.filePath.present ? data.filePath.value : this.filePath,
      serverFilePath: data.serverFilePath.present
          ? data.serverFilePath.value
          : this.serverFilePath,
  ...
  @override
  String toString() {
    return (StringBuffer('WoundPhoto(')
          ..write('id: $id, ')
          ..write('patientId: $patientId, ')
          ..write('filePath: $filePath, ')
          ..write('serverFilePath: $serverFilePath, ')
          ..write('note: $note, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is WoundPhoto &&
          ...
          other.serverFilePath == this.serverFilePath &&
...
class WoundPhotosCompanion extends UpdateCompanion<WoundPhoto> {
  final Value<String> id;
  final Value<String> patientId;
  final Value<String> filePath;
  final Value<String> serverFilePath;
  final Value<String> note;
  final Value<DateTime> capturedAt;
  final Value<String> capturedBy;
  final Value<String> status;
  final Value<int> rowid;
  const WoundPhotosCompanion({
    this.id = const Value.absent(),
    this.patientId = const Value.absent(),
    this.filePath = const Value.absent(),
    this.serverFilePath = const Value.absent(),
  ...
  WoundPhotosCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       capturedBy = Value(capturedBy),
       status = Value(status);
  static Insertable<WoundPhoto> custom({
    Expression<String>? id,
    Expression<String>? patientId,
    Expression<String>? filePath,
    Expression<String>? serverFilePath,
    ...
    return RawValuesInsertable({
      ...
      if (serverFilePath != null) 'server_file_path': serverFilePath,
  ...
  WoundPhotosCompanion copyWith({
    Value<String>? id,
    Value<String>? patientId,
    Value<String>? filePath,
    Value<String>? serverFilePath,
    Value<String>? note,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (serverFilePath.present) {
      map['server_file_path'] = Variable<String>(serverFilePath.value);
    }
    if (note.present) {
  ...
  @override
  String toString() {
    return (StringBuffer('WoundPhotosCompanion(')
          ..write('id: $id, ')
          ..write('patientId: $patientId, ')
          ..write('filePath: $filePath, ')
          ..write('serverFilePath: $serverFilePath, ')
...
class VoiceNote extends DataClass implements Insertable<VoiceNote> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, patientId, filePath, createdAt, durationSeconds, status);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is VoiceNote &&
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $WoundPhotosTable woundPhotos = $WoundPhotosTable(this);
  ...
  late final EntityVersionsDao entityVersionsDao = EntityVersionsDao(
    this as AppDatabase,
  );
  late final VitalDao vitalDao = VitalDao(this as AppDatabase);
  late final MessageDao messageDao = MessageDao(this as AppDatabase);
  late final WoundPhotoDao woundPhotoDao = WoundPhotoDao(this as AppDatabase);
...
typedef $$SyncConflictsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$EntityVersionsTableCreateCompanionBuilder =
    EntityVersionsCompanion Function({
      required String entityType,
      required String entityId,
      Value<int> version,
      required DateTime updatedAt,
...
typedef $$EntityVersionsTableUpdateCompanionBuilder =
    EntityVersionsCompanion Function({
      Value<String> entityType,
      Value<String> entityId,
      Value<int> version,
...
class $$EntityVersionsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $EntityVersionsTable,
          ...
          (
            EntityVersion,
            BaseReferences<_$AppDatabase, $EntityVersionsTable, EntityVersion>,
          ),
          EntityVersion,
          PrefetchHooks Function()
        > {
...
typedef $$EntityVersionsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $EntityVersionsTable,
      EntityVersion,
...
typedef $$MessagesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$WoundPhotosTableCreateCompanionBuilder =
    WoundPhotosCompanion Function({
      required String id,
      required String patientId,
      required String filePath,
      Value<String> serverFilePath,
...
typedef $$WoundPhotosTableUpdateCompanionBuilder =
    WoundPhotosCompanion Function({
      Value<String> id,
      Value<String> patientId,
      Value<String> filePath,
...
class $$WoundPhotosTableFilterComposer
    extends Composer<_$AppDatabase, $WoundPhotosTable> {
  $$WoundPhotosTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnFilters<String> get serverFilePath => $composableBuilder(
    column: $table.serverFilePath,
    builder: (column) => ColumnFilters(column),
  );
...
class $$WoundPhotosTableOrderingComposer
    extends Composer<_$AppDatabase, $WoundPhotosTable> {
  $$WoundPhotosTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnOrderings<String> get serverFilePath => $composableBuilder(
    column: $table.serverFilePath,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$WoundPhotosTableAnnotationComposer
    extends Composer<_$AppDatabase, $WoundPhotosTable> {
  $$WoundPhotosTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  GeneratedColumn<String> get serverFilePath => $composableBuilder(
    column: $table.serverFilePath,
    builder: (column) => column,
  );
...
class $$WoundPhotosTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $WoundPhotosTable,
          ...
          $$WoundPhotosTableOrderingComposer,
          $$WoundPhotosTableAnnotationComposer,
          $$WoundPhotosTableCreateCompanionBuilder,
          $$WoundPhotosTableUpdateCompanionBuilder,
          (
            WoundPhoto,
            BaseReferences<_$AppDatabase, $WoundPhotosTable, WoundPhoto>,
          ),
          WoundPhoto,
          PrefetchHooks Function()
        > {
  $$WoundPhotosTableTableManager(_$AppDatabase db, $WoundPhotosTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$WoundPhotosTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$WoundPhotosTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$WoundPhotosTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> id = const Value.absent(),
                Value<String> patientId = const Value.absent(),
                Value<String> filePath = const Value.absent(),
                Value<String> serverFilePath = const Value.absent(),
...
typedef $$WoundPhotosTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $WoundPhotosTable,
      WoundPhoto,
...
class $$VoiceNotesTableTableManager
    extends
        RootTableManager<
          ...
          (
            VoiceNote,
            BaseReferences<_$AppDatabase, $VoiceNotesTable, VoiceNote>,
          ),
          VoiceNote,
          PrefetchHooks Function()
        > {
...
typedef $$VoiceNotesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      $$VoiceNotesTableCreateCompanionBuilder,
      $$VoiceNotesTableUpdateCompanionBuilder,
      (VoiceNote, BaseReferences<_$AppDatabase, $VoiceNotesTable, VoiceNote>),
      VoiceNote,
      PrefetchHooks Function()
    >;
...
class $AppDatabaseManager {
  ...
  $$WoundPhotosTableTableManager get woundPhotos =>
      $$WoundPhotosTableTableManager(_db, _db.woundPhotos);
